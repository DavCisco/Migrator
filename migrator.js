...
const scopes = 'spark:kms spark-admin:devices_write spark-admin:places_write spark-admin:organizations_read identity:placeonetimepassword_create spark-admin:people_read';
const port = '8080';
